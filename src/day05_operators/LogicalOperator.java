...
public class LogicalOperator {
	...
	public static void main(String[] args) {
		...
		System.out.println(userName=="techcircle" && password =="abc123"); // true
		System.out.println(userName=="hello" && password =="abc123");      // false
		System.out.println(userName=="techcircle" && password =="abc124"); // false
